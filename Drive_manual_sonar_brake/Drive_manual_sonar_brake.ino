...
#include <TimerOne.h>
#define MAXTIME 4  // multiply with precision to get actual time set to 4
...
//   if (abs(g_distance) > 15 && LATI != 0 && LONGI != 0 && gsm_v_lati != 0 && gsm_v_longi != 0 )
    {
     driveBLDC();
    }

  
//  else if (abs(g_distance) < 15 && durationFlag == 100)
//  {
